...
LaptopRoutes.route('/return/:id').post(function (req, res) {
    Laptop.findById(req.params.id, function (err, laptop) {
        ...
        let newHistoryItem = {};
        newHistoryItem.staffMemberName = laptop.lendInfo.staffMemberName;
        newHistoryItem.lendDate = laptop.lendInfo.lendDate;
        newHistoryItem.expectedReturnDate = laptop.lendInfo.expectedReturnDate;
        newHistoryItem.actualReturnDate = new Date();

        newHistoryItem.tssEmployeeName = laptop.lendInfo.tssEmployeeName;

        laptop.lendInfo = null;
        laptop.history.push(newHistoryItem)
        console.log('New Histroy Item', newHistoryItem)
        laptop.save().then(laptop => {
            console.log('Add to History')
            console.log(laptop.history[0])
